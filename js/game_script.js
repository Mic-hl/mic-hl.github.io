...
function createStatsDisplay() {
    ...
    tableInfo.innerHTML = "HIGH SCORES<br><span class=\"btm\" style=\"margin-top: 2px;"
        + "margin-bottom: 25px;\">The time is displayed in seconds. Click here to display it in minutes.</span>";
